# 1)Pr√©parer les donn√©es sous formes des data frame
...
# 4) PrÈpartion des sÈries mÈtÈorologiques sous forme  data frame
...
# Faire analayse pour les diffÈrents quantiles : 95% voir aussi 98% /99%


# Angstrom index

##TempÈrature et humiditÈ ? 13h
